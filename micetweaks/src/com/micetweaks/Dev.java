...
public class Dev {
	 ...
	 *            device's ID set.
	 * @param speed
	 *            0.3 to 1.2 recomended.
	 * @param deacceleration
	 *            1.0 to 1.8 recommended.
	 * @throws IOException
	 * @throws InterruptedException
	 */
	public static void setProp(HashSet<? extends Number> devsID, String speed,
			String deacceleration) throws IOException, InterruptedException {
	 ...
	 * 
	 * @param devName
	 *            device name taken from "xinput" command.
	 * @param speed
	 *            0.3 to 1.2 recomended.
	 * @param deacceleration
	 *            1.0 to 1.8 recommended.
